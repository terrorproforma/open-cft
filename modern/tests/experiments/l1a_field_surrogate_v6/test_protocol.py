...
from experiments.l1a_field_surrogate_v6.protocol import (
    DEPENDENCY_LOCK,
    GEOMETRY_PREFLIGHT,
    PARTITIONS,
    SYNTHETIC_PREFLIGHT,
...
from experiments.l1a_field_surrogate_v6.run import (
...
@pytest.mark.parametrize(
    "status",
    (
        " M modern/experiments/l1a_field_surrogate_v6/predeclaration.json",
        "M  modern/experiments/l1a_field_surrogate_v6/run.py",
        "?? foreign-untracked.txt",
        "?? modern/experiments/l1a_field_surrogate_v6/results-sibling/file.json",
    ),
)
