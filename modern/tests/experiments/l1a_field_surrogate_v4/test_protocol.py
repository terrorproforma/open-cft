...
from experiments.l1a_field_surrogate_v4.protocol import (
    DEPENDENCY_LOCK,
    GEOMETRY_PREFLIGHT,
    PARTITIONS,
    SYNTHETIC_PREFLIGHT,
...
from experiments.l1a_field_surrogate_v4.run import (
    load_checkpoint,
    new_counters,
    save_checkpoint,
...
def test_sealed_preflight_is_complete_and_solver_free() -> None:
    ...
    assert runtime["executed_path_hashes"]


def test_sidecars_and_text_are_lf_bytes() -> None:
