"""Preregistered identities for field-surrogate v6."""
...
if PROTOCOL["schema_version"] != "cft-revival.l1a-field-surrogate-v6.protocol/6.0.0":
    raise ValueError("unsupported v6 protocol")
