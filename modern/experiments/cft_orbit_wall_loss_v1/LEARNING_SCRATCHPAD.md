...
- Task: preregister and execute CFT full-orbit wall-loss v1.
...
- [tool] Orbit launch seeds are unsigned 64-bit values while shared runtime JSON
  accepts signed 64-bit integers. Preregistered runtime manifests encode seeds
  as decimal strings; opaque orbit/checkpoint JSON is gzip-wrapped in the
  runtime bundle while retaining its exact uncompressed SHA-256 authority.
