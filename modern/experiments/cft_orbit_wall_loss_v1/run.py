...
SUBJECT = "preregister CFT full-orbit wall-loss v1"
REMOTE_BRANCH = "origin/exp/cft-orbit-wall-loss-v1"
COMMAND = "python -m experiments.cft_orbit_wall_loss_v1.run execute"
...
def prepare() -> dict[str, Any]:
    ...
    launch_payload = {
        "schema_version": "cft-revival.cft-orbit-wall-loss-v1.launches/1.0.0",
        "estimator_policy": EstimatorPolicy.UNWEIGHTED_BINOMIAL.value,
        "launches": runtime_launch_records(launches),
    }
    launch_payload["launches_sha256"] = content_hash(launch_records(launches))
    launch_payload["seed_encoding"] = "unsigned-64 decimal string in runtime JSON"
    batch_payload = {
        "schema_version": "cft-revival.cft-orbit-wall-loss-v1.batches/1.0.0",
        "estimator_policy": EstimatorPolicy.UNWEIGHTED_BINOMIAL.value,
        "batches": batches,
    }
    batch_payload["batch_manifest_sha256"] = content_hash(
        {
            "estimator_policy": EstimatorPolicy.UNWEIGHTED_BINOMIAL.value,
            "batches": batches,
        }
    ...
    synthetic = {
        "schema_version": "cft-revival.cft-orbit-wall-loss-v1.synthetic-preflight/1.0.0",
        "protocol_semantic_sha256": semantic_sha256(value),
        "launches_sha256": launch_payload["launches_sha256"],
        "batch_manifest_sha256": batch_payload["batch_manifest_sha256"],
        ...
        "passed": manufactured["passed"],
    }
    authorities = {
        "schema_version": "cft-revival.cft-orbit-wall-loss-v1.authorities/1.0.0",
        "protocol_semantic_sha256": semantic_sha256(value),
        "launches_sha256": launch_payload["launches_sha256"],
        "batch_manifest_sha256": batch_payload["batch_manifest_sha256"],
    ...
    _write(LAUNCH_MANIFEST_PATH, launch_payload)
    _write(BATCH_MANIFEST_PATH, batch_payload)
    ...
    return {
        ...
        "launches_sha256": authorities["launches_sha256"],
...
def _bind_preregistration() -> str:
    ...
    prefix = "modern/experiments/cft_orbit_wall_loss_v1/"
...
def execute() -> dict[str, Any]:
    ...
    cache_root = (
        ...
        / f"cft-orbit-wall-loss-v1-{commit[:12]}-working-cache"
    )
