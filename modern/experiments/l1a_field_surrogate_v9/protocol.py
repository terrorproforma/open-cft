"""Preregistered identities for field-surrogate v9."""
...
if PROTOCOL["schema_version"] != "cft-revival.l1a-field-surrogate-v9.protocol/9.0.0":
    raise ValueError("unsupported v9 protocol")
