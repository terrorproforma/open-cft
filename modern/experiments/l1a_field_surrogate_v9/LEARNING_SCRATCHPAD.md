# L1a field-surrogate v9 learning scratchpad

## Pre-registration observations

- [user] Preserve v1-v8 and use only v8 development evidence for v9.
- [self] Coordinate exclusion is an integrity dependency, not scientific
  tuning; the dependency lock distinguishes prior partitions from the sole v8
