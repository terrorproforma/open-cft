"""Preregistered identities for field-surrogate v8."""
...
if PROTOCOL["schema_version"] != "cft-revival.l1a-field-surrogate-v8.protocol/8.0.0":
    raise ValueError("unsupported v8 protocol")
