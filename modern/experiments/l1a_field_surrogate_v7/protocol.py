"""Preregistered identities for field-surrogate v7."""
...
if PROTOCOL["schema_version"] != "cft-revival.l1a-field-surrogate-v7.protocol/7.0.0":
    raise ValueError("unsupported v7 protocol")
